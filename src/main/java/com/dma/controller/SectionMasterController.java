...
public class SectionMasterController {
	...
	@GetMapping("/getSectionsById/{id}")
	public SectionMaster getAllSection(@PathVariable (value = "id") long section_id)
	{
		return sectionMasterRepository.findById(section_id).get();
	}
